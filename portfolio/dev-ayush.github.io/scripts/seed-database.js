...
const existingTestimonials = [
  {
    ...
    content: 'Working with Ayush was an absolute pleasure. His expertise in AI and machine learning helped us build cutting-edge solutions that exceeded our expectations. The ChatPDF project he delivered revolutionized how our medical research team analyzes clinical trial documents.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Ayush\'s work on our FinChat AI assistant was exceptional. He demonstrated deep understanding of both technical implementation and business requirements. The multi-agent system he built has significantly improved our customer engagement rates.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'The SRS Agent tool that Ayush developed for our medical software documentation has been a game-changer. His attention to detail and understanding of healthcare compliance requirements made the project a huge success.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'The POS automation system Ayush built integrated seamlessly with all our existing systems. His expertise with AWS and API integration made what seemed impossible, possible. Highly recommend his services!',
    rating: 4,
  ...
  },
  {
    ...
    content: 'Ayush brings a unique combination of technical excellence and business acumen. His work on our cloud migration to Azure was flawless, and his proactive communication throughout the project was outstanding.',
    rating: 5,
